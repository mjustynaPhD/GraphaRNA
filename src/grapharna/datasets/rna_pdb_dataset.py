...
class RNAPDBDataset(Dataset):
    def __init__(self,
        ...
        if mode not in ['backbone', 'all', 'coarse-grain', 'p-only']:
    ...
    def get_raw_sample(self, idx):
        ...
        atoms_pos /= 10
        c4_primes = c2 = c4_or_c6 = n1_or_n9 = None
    ...
    def p_only(self, atom_pos, atom_types, sample):
        mask = [True if atom == 'P' else False for atom in sample['symbols']]
        return atom_pos[mask], atom_types[mask], sample['residues'][mask]
